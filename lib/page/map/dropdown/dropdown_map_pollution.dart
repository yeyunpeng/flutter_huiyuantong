...
class DropDownMapPollution extends StatefulWidget with EasyPopupChild{
  final _PopController controller = _PopController();
  PollutionDetailsModel airsitedetailsmodel;
  List<PollRealtimeData> RealtimeDataList ;
  String outId ;
  DropDownMapPollution(this.outId,this.airsitedetailsmodel,this.RealtimeDataList,{Key? key}) : super(key: key);
  @override
  _DropDownMapPollutionState createState() => _DropDownMapPollutionState();
...
class _DropDownMapPollutionState extends State<DropDownMapPollution>
                  ...
                  child: Container(
                    ...
                    child:  Column(children: [
                      ...
                      Row(children: [
                        ...
                        Text(widget.airsitedetailsmodel.data!.outletName.toString(),style: TextStyle(color: const Color.fromRGBO(185, 233, 255, 1),fontSize: Adapt.px(32)),),
                      ...
                      Row(children: [
                        SizedBox(width: Adapt.px(32),),
                        SizedBox(width: Adapt.px(256),child:    Text('所属企业：${widget.airsitedetailsmodel.data!.comName.toString()}',
                      ...
                      InkWell(
                        onTap: (){
                          dismiss();
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> OutletDetails(widget.outId)));
                        },
                        child:   Text('查看排口详情 >',style: TextStyle(color: const Color.fromRGBO(46, 228, 149, 1),fontSize: Adapt.px(24)),),
                      ),
                    ],),
                  ),
                ),
...
class _PopController {
  late _DropDownMapPollutionState state;

  _bindState(_DropDownMapPollutionState state) {
    this.state = state;
  }
