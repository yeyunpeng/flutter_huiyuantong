...
import 'package:flutter_huiyuantong/page/water_section_page.dart';
import 'package:flutter_huiyuantong/util/adapt.dart';
class HomeWaterPage extends StatefulWidget{
  @override
  _HomeWaterPageState createState()=>_HomeWaterPageState();
}
class _HomeWaterPageState extends State<HomeWaterPage>{
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      InkWell(
                        onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>WaterSection()));},
                        child: Container(
                          width: Adapt.px(327),
                          height: Adapt.px(144),
                                ...
                                Column(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Image(image: AssetImage('images/duanmian.png')),
                                    ),
                                  ],)
                                ,
                                ...
                                children: [
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      ...
                                      Image(image: AssetImage('images/heliu.png'),width: Adapt.px(48),height: Adapt.px(48),),
                                    ],
                                  )
                            ...
                            children: [
                              ...
                              Stack(
                                ...
                                children: [
                                  ...
                                  Image(image: AssetImage('images/waterzhanbi.png'),width: Adapt.px(48),height: Adapt.px(48),),
                                ],
                              )
